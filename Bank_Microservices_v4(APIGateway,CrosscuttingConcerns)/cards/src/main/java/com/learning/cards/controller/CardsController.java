...
import com.learning.cards.dto.CardsContactInfoDto;
...
@RestController
@RequestMapping(path = "/v1.0/cards", produces = {MediaType.APPLICATION_JSON_VALUE})
...
public class CardsController {
    ...
    public ResponseEntity<CardsDto> fetchCardDetails(@RequestHeader("ramBank-correlation-id") String correlationId, @RequestParam
                                                     @Pattern(regexp = "(^$|[0-9]{10})", message = "Mobile number must be 10 digits")
                                                     String mobileNumber) {
